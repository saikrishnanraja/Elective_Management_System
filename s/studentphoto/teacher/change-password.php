...
{
$sql=mysqli_query($con,"SELECT password FROM  teacher where password='".md5($_POST['cpass'])."' && username='".$_SESSION['tlogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update teacher set password='".md5($_POST['newpass'])."' where username='".$_SESSION['tlogin']."'");
 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Teacher Change Password </h1>
                    </div>
                </div>
                <div class="row" >
...
<button class="btn btn-default"><a href="logout.php">Log out</a>
                            </div>
                            </div>
                    </div>

            ...
            <div class="row">
                <div class="col-md-6">
                     <label>Enter Reg no : </label>
                        ...
                        <button class="btn btn-info" style="outline: none;"><span class="glyphicon glyphicon-user"></span><a href="admin/student-registration.php" style="text-decoration: none; color: inherit;">Register Now</a></button>

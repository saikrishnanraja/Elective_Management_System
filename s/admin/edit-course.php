...
$ret=mysqli_query($con,"update course set courseCode='$coursecode',courseName='$coursename',courseUnit='$courseunit',noofSeats='$seatlimit',credits='$coursecred',updationDate='$currentTime' where id='$id'");
if($ret)
{
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="coursecred" name="coursecred" placeholder="Course credits" value="<?php echo htmlentities($row['credits']);?>" required />
  </div> 

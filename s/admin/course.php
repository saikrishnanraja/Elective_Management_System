...
$coursecred=$_POST['coursecred'];
$seatlimit=$_POST['seatlimit'];
$ret=mysqli_query($con,"insert into course(courseCode,courseName,courseUnit,noofSeats,credits) values('$coursecode','$coursename','$courseunit','$seatlimit','$coursecred')");
if($ret)
{
...
<div class="form-group">
    <label for="coursecred">Course credits  </label>
    <input type="text" class="form-control" id="coursecred" name="coursecred" placeholder="Course credits" required />
  </div> 
...
<div class="form-group">
 ...
 <button type="submit" name="submit" class="btn btn-default">Submit</button><hr>
 <a href="cdline.php">Set Elective Registration Dates</a>
</form>
                            </div>
                            </div>
                    </div>

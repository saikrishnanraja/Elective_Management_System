...
$ret=mysqli_query($con,"insert into department(department,maxcredits) values('$department','$departmentc')");
if($ret)
{
...
<font color="green" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
   ...
   <div class="form-group">
    ...
    <label for="departmentc">Max credits  </label>
    <input type="text" class="form-control" id="departmentc" name="departmentc" placeholder="Max allowed credits" required />
  </div>
...
?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($row['maxcredits']);?></td>
